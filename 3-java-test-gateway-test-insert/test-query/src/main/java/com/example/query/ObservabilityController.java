...
class ObservabilityController {
    ...
    String metrics() {
        ...
        return """
                ...
                mock_service_up{service="test-query",host="sample-host-b"} 1
                # HELP mock_db_events_total Current event rows in the sample database.
                # TYPE mock_db_events_total gauge
                mock_db_events_total{service="test-query",database="mysql/order_fulfillment.orders"} %d
                ...
                mock_http_server_requests_total{service="test-query",api="/api/query"} %d
